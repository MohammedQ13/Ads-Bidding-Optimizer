...
| Round 4 mdn_wide (1024-512-256-128, dp=0.02) | 4.40 | **0.12** | 22.50 | 46.89 |
...
### Did not work
1. Wider/deeper architectures (1024-512-256-128 hidden, 5-layer): all worse.
...
10. Wider MDN (1024-512-256-128) was best-calibrated (KS 0.12) but regret 22.50, calibration != regret.
...
5. **Architecture changes hit a wall**: every wider/deeper variant was *worse*, not better. The 4-layer 512-256-128-64 MLP backbone is the right capacity for ~10M training rows of this feature pipeline.
